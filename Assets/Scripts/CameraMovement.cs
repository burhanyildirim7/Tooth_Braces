...
public class CameraMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (GameController.instance.asamaSayisi >= 1 && Vector3.Distance(transform.position, -Vector3.forward * 12 - Vector3.up * 1.25f) >= .2f)
        {
            transform.DOMove(-Vector3.forward * 12 - Vector3.up * 1.25f, 1.25f);
        }
    }
